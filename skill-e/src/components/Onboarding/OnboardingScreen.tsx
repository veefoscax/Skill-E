...
export function OnboardingScreen({ onComplete }: OnboardingProps) {
  ...
  const [modelStatus, setModelStatus] = useState<'checking' | 'found' | 'missing' | 'downloading'>(
    'checking'
  )
        ...
        {step === 'welcome' && (
          <div className="space-y-6 pt-2 animate-in fade-in zoom-in-95 duration-300">
            ...
            <p className="text-muted-foreground">
              ...
              <br />
              We'll record your screen and voice to generate executable skills.
            </p>
          ...
          <div className="space-y-6 w-full animate-in slide-in-from-right-10 duration-300 pt-2">
            ...
            <div className="space-y-2">
              <Button
                ...
                disabled={isValidating || (llmProvider !== 'ollama' && !llmApiKey)}
              >
                {isValidating ? (
              ...
              {transcriptionMethod === 'local' ? (
                modelStatus === 'found' ? (
                  ...
                  <Button
                    ...
                    disabled={modelStatus === 'downloading' || modelStatus === 'checking'}
                  >
                    {modelStatus === 'downloading'
                      ? 'Downloading...'
                      : `Download ${WHISPER_MODEL_INFO[selectedModel].name} Model`}
                    {!['downloading', 'checking'].includes(modelStatus) && (
