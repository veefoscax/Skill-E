 ...
 */
export function SkillPreview({ skill, className, onRegenerate }: SkillPreviewProps) {
    ...
    <div className={cn('flex flex-col space-y-6', className)}>
      ...
      <div className="grid grid-cols-3 gap-4">
        <div className="rounded-lg border bg-card p-4">
          ...
          <div className="text-2xl font-bold text-foreground">{formatFileSize(fileSizeBytes)}</div>
        </div>
        ...
        <div className="rounded-lg border bg-card p-4">
          ...
          {skill.tokenCount > 5000 && (
            <p className="text-xs text-destructive mt-1">Exceeds recommended limit (5000)</p>
          )}
        </div>
          ...
          {skill.frontmatter.compatibility ? (
            <div className="grid grid-cols-[120px_1fr] gap-2">
              ...
              <span className="text-sm text-foreground">
                {String(skill.frontmatter.compatibility)}
              </span>
            </div>
          ) : null}
