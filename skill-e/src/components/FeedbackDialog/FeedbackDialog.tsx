...
export function FeedbackDialog({
  ...
  const categorizedError =
    providedCategorizedError || (step && error ? categorizeError(step, undefined, error) : null)
    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="sm:max-w-[600px] max-h-[90vh] overflow-y-auto">
        <DialogHeader>
          ...
          <DialogDescription>
            Step {step.index + 1} encountered an error. Review the details and choose how to
            proceed.
          </DialogDescription>
        </DialogHeader>
        ...
        <div className="space-y-4 py-4">
          ...
          <div className="space-y-2">
            ...
            <div className="p-3 rounded-md border bg-muted/50">
              ...
              {step.section && (
                <p className="text-xs text-muted-foreground mt-1">Section: {step.section}</p>
              )}
            </div>
          </div>
          ...
          {errorScreenshot && (
            <div className="space-y-2">
              ...
              <div className="rounded-md border overflow-hidden">
                <img src={errorScreenshot} alt="Error state" className="w-full h-auto" />
              </div>
            </div>
          )}
                    ...
                    <div className="flex items-start gap-2">
                      <CheckCircle2
                        className={`h-4 w-4 mt-0.5 flex-shrink-0 ${
                          selectedSuggestion === index ? 'text-primary' : 'text-muted-foreground'
                        }`}
                      />
          ...
          <div className="space-y-2">
            ...
            <p className="text-xs text-muted-foreground">
              Your feedback will help improve the skill and may be used to automatically fix the
              step.
            </p>
          </div>
        </div>
