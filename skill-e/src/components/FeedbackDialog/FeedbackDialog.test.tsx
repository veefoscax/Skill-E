...
describe('FeedbackDialog', () => {
  ...
  const mockCategorizedError: CategorizedError = {
    ...
    severity: 'medium',
    message:
      'Step 1 (click): Target not found. Could not locate the element or target specified in the step.',
    technicalDetails: 'Element not found: #submit-btn',
    userMessage:
      'Could not find the target for "Click the Submit button". The element might have moved, changed, or not be visible yet.',
    suggestions: [
      {
