    ...
    try {
      ...
      try {
        ...
        if (error.name === 'NotAllowedError') {
          ...
          addLog(
            `      C:\\Users\\<your-username>\\AppData\\Local\\com.vfoscaches.skill-e\\EBWebView\\Default\\Preferences`
          )
        ...
        <ol className="list-decimal list-inside space-y-1 text-sm text-muted-foreground">
          <li>
            ...
            <code className="bg-gray-800 px-1 rounded text-xs">
              %LOCALAPPDATA%\com.vfoscaches.skill-e\EBWebView\Default\Preferences
            </code>
          </li>
          <li>
