  ...
  switch (errorType) {
    ...
    case 'MODEL_DOWNLOAD_FAILED':
      return {
        ...
        description: 'The local Whisper model could not be found or downloaded. This is a ~75MB file required for transcription.',
        actions: [
    ...
    case 'WHISPER_TIMEOUT':
      return {
        ...
        description: 'The local Whisper transcription took too long. This might happen with longer recordings or slower computers.',
        actions: [
    ...
    case 'WHISPER_FAILED':
      return {
        ...
        description: 'The local Whisper transcription failed. This could be due to audio format issues or system resources.',
        actions: [
          { label: 'Try Again', action: 'retry' },
          { label: 'Use OpenAI API', action: 'api' },
          { label: 'Open Settings', action: 'settings' }
    ...
    case 'NO_AUDIO':
      return {
        ...
        description: 'No audio was recorded. Please ensure your microphone is working and try again.',
        actions: [
          { label: 'Check Microphone', action: 'settings' }
        ]
      };
