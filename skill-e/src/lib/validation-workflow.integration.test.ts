...
import { generateSkillFix, validateSkillUpdate } from './skill-updater'
...
`
      ...
      const fixEntry = timeline.find(
        e => e.message.includes('Fix generated') || e.message.includes('Fix applied')
      )
