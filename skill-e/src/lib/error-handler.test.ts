...
describe('Error Handler', () => {
  ...
  describe('Context-Aware Suggestions', () => {
    it('should suggest image-based automation for not found errors', () => {
      ...
      const imageSuggestion = result.suggestions.find(s => s.text.includes('image-based'))
    ...
    it('should suggest manual completion for permission errors', () => {
      ...
      const manualSuggestion = result.suggestions.find(s => s.action === 'manual')
    ...
    it('should suggest abort for critical errors', () => {
      ...
      const abortSuggestion = result.suggestions.find(s => s.action === 'abort')
