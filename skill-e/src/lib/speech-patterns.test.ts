...
describe('Speech Patterns - Portuguese Variable Detection', () => {
  ...
  it('should detect "qualquer email" pattern', () => {
    ...
    const pattern = VARIABLE_PATTERNS_PT.find(p => 
      p.pattern.source.includes('qualquer') && p.pattern.test(text)
    );
  ...
  it('should detect "digita o código" pattern', () => {
    ...
    const pattern = VARIABLE_PATTERNS_PT.find(p => 
      p.pattern.source.includes('digita') && p.pattern.test(text)
    );
  ...
  it('should detect "seleciona o tipo" pattern', () => {
    ...
    const pattern = VARIABLE_PATTERNS_PT.find(p => 
      p.pattern.source.includes('seleciona') && p.pattern.test(text)
    );
  ...
  it('should detect "faz upload do arquivo" pattern', () => {
    ...
    const pattern = VARIABLE_PATTERNS_PT.find(p => 
      p.pattern.source.includes('upload') && p.pattern.test(text)
    );
...
describe('Speech Patterns - English Variable Detection', () => {
  ...
  it('should detect "any email" pattern', () => {
    ...
    const pattern = VARIABLE_PATTERNS_EN.find(p => 
      p.pattern.source.includes('any') && p.pattern.test(text)
    );
  ...
  it('should detect "type the code" pattern', () => {
    ...
    const pattern = VARIABLE_PATTERNS_EN.find(p => 
      p.pattern.source.includes('type') && p.pattern.test(text)
    );
  ...
  it('should detect "select the option" pattern', () => {
    ...
    const pattern = VARIABLE_PATTERNS_EN.find(p => 
      p.pattern.source.includes('select') && p.pattern.test(text)
    );
...
describe('Speech Patterns - Portuguese Conditionals', () => {
  ...
  it('should detect "quando X for Y" pattern', () => {
    ...
    const pattern = CONDITIONAL_PATTERNS_PT.find(p => 
      p.pattern.source.includes('quando') && p.pattern.test(text)
    );
  ...
  it('should detect "dependendo de X" pattern', () => {
    ...
    const pattern = CONDITIONAL_PATTERNS_PT.find(p => 
      p.pattern.source.includes('dependendo') && p.pattern.test(text)
    );
...
describe('Speech Patterns - English Conditionals', () => {
  ...
  it('should detect "when X is Y" pattern', () => {
    ...
    const pattern = CONDITIONAL_PATTERNS_EN.find(p => 
      p.pattern.source.includes('when') && p.pattern.test(text)
    );
  ...
  it('should detect "depending on X" pattern', () => {
    ...
    const pattern = CONDITIONAL_PATTERNS_EN.find(p => 
      p.pattern.source.includes('depending') && p.pattern.test(text)
    );
...
describe('Speech Patterns - Portuguese Context', () => {
  ...
  it('should detect "presta atenção" pattern', () => {
    ...
    const pattern = CONTEXT_PATTERNS_PT.find(p => 
      p.pattern.source.includes('presta') && p.pattern.test(text)
    );
  ...
  it('should detect "geralmente" pattern', () => {
    ...
    const pattern = CONTEXT_PATTERNS_PT.find(p => 
      p.pattern.source.includes('geralmente') && p.pattern.test(text)
    );
...
describe('Speech Patterns - English Context', () => {
  ...
  it('should detect "pay attention" pattern', () => {
    ...
    const pattern = CONTEXT_PATTERNS_EN.find(p => 
      p.pattern.source.includes('attention') && p.pattern.test(text)
    );
  ...
  it('should detect "usually" pattern', () => {
    ...
    const pattern = CONTEXT_PATTERNS_EN.find(p => 
      p.pattern.source.includes('usually') && p.pattern.test(text)
    );
