  ...
  const mockReferences: DocReference[] = [
    {
      ...
      snippet: 'Hooks are functions that let you use state and other React features without writing a class.',
    ...
    },
    {
      ...
      snippet: 'DataFrame is a 2-dimensional labeled data structure with columns of potentially different types.',
