  ...
  describe('validateSkillSemantics', () => {
    it('should validate a high-quality skill', async () => {
      ...
      const mockResponse = JSON.stringify({
        ...
        weaknesses: ['Could add more troubleshooting tips'],
        recommendations: ['Add a troubleshooting section for common errors'],
      })
    ...
    it('should validate a medium-quality skill', async () => {
      ...
      const mockResponse = JSON.stringify({
        ...
        clarity: 75,
        completeness: 65,
        strengths: ['Basic instructions are clear', 'Includes some verification steps'],
        weaknesses: [
      ...
      const result = await validateSkillSemantics('Delete old files', '# Delete Files\n\nSteps...')
    ...
    it('should validate a low-quality skill', async () => {
      ...
      const mockResponse = JSON.stringify({
        ...
        clarity: 40,
        completeness: 35,
        strengths: ['Attempts to describe the task'],
        weaknesses: [
    ...
    it('should handle custom weights', async () => {
      ...
      const result1 = await validateSkillSemantics('Task', 'Skill')
      ...
      const result2 = await validateSkillSemantics('Task', 'Skill', {
        weights: {
          safety: 0.8,
          clarity: 0.1,
          completeness: 0.1,
    ...
    it('should reject invalid weights', async () => {
      await expect(
        validateSkillSemantics('Task', 'Skill', {
          weights: {
            safety: 0.5,
            clarity: 0.3,
...
Hope this helps!`
      ...
      const result = await validateSkillSemantics('Task', 'Skill')
  ...
  describe('formatValidationResultMarkdown', () => {
    it('should format a verified result', () => {
      const result: SemanticValidationResult = {
        ...
        strengths: ['Excellent safety measures', 'Clear instructions'],
        weaknesses: ['Minor improvement needed'],
        recommendations: ['Add one more example'],
        isVerified: true,
      }
