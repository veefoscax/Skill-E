...
export const VARIABLE_PATTERNS_PT: VariablePattern[] = [
  {
    pattern: /o nome (do|da|de) (\w+)/i,
    extract: 2,
    type: VariableType.TEXT,
    description: 'Nome pattern',
  },
  {
    pattern: /o (email|e-mail) (do|da|de)?/i,
    extract: 0,
    type: VariableType.TEXT,
    description: 'Email pattern',
  },
  {
    pattern: /o (telefone|celular) (do|da|de)?/i,
    extract: 0,
    type: VariableType.TEXT,
    description: 'Phone pattern',
  },
  {
    pattern: /o (cpf|cnpj|rg|documento) (do|da|de)?/i,
    extract: 0,
    type: VariableType.TEXT,
    description: 'Document pattern',
  },
  {
    pattern: /o (código|id|identificador) (do|da|de)?/i,
    extract: 0,
    type: VariableType.TEXT,
    description: 'ID pattern',
  },
  {
    pattern: /qualquer (\w+)/i,
    extract: 1,
    type: VariableType.TEXT,
    description: 'Qualquer pattern',
  },
  {
    pattern: /um (\w+) qualquer/i,
    extract: 1,
    type: VariableType.TEXT,
    description: 'Um qualquer pattern',
  },
  {
    pattern: /isso (aqui )?(vai|pode|deve) mudar/i,
    extract: 0,
    type: VariableType.TEXT,
  ...
  {
    pattern: /depende (do|da|de) (\w+)/i,
    extract: 2,
    type: VariableType.TEXT,
    description: 'Depends pattern',
  },
  {
    pattern: /digita (aqui )?(o|a) (\w+)/i,
    extract: 3,
    type: VariableType.TEXT,
    description: 'Type instruction',
  },
  {
    pattern: /coloca (aqui )?(o|a) (\w+)/i,
    extract: 3,
    type: VariableType.TEXT,
    description: 'Put instruction',
  },
  {
    pattern: /seleciona (o|a) (\w+)/i,
    extract: 2,
    type: VariableType.SELECTION,
    description: 'Select instruction',
  },
  {
    pattern: /escolhe (o|a) (\w+)/i,
    extract: 2,
    type: VariableType.SELECTION,
    description: 'Choose instruction',
  },
  {
    pattern: /faz upload (do|da|de) (\w+)/i,
    extract: 2,
    type: VariableType.FILE,
    description: 'Upload instruction',
  },
  {
    pattern: /a data (do|da|de) (\w+)/i,
    extract: 2,
    type: VariableType.DATE,
    description: 'Date mention',
  },
  {
    pattern: /o (número|valor|quantidade) (do|da|de) (\w+)/i,
    extract: 3,
    type: VariableType.NUMBER,
    description: 'Number mention',
  },
]
...
export const VARIABLE_PATTERNS_EN: VariablePattern[] = [
  ...
  {
    pattern: /the (email|e-mail) (address)?/i,
    extract: 0,
    type: VariableType.TEXT,
    description: 'Email pattern',
  },
  {
    pattern: /the (phone|telephone|mobile) (number)?/i,
    extract: 0,
    type: VariableType.TEXT,
    description: 'Phone pattern',
  },
  {
    pattern: /the (id|identifier|code)/i,
    extract: 0,
    type: VariableType.TEXT,
    description: 'ID pattern',
  },
  ...
  {
    pattern: /a (\w+) of your choice/i,
    extract: 1,
    type: VariableType.TEXT,
    description: 'Choice pattern',
  },
  {
    pattern: /this (will|can|might) (change|vary|differ)/i,
    extract: 0,
    type: VariableType.TEXT,
    requiresContext: true,
    description: 'Dynamic content',
  ...
  {
    pattern: /depends on (the )?(\w+)/i,
    extract: 2,
    type: VariableType.TEXT,
    description: 'Depends pattern',
  },
  {
    pattern: /type (in )?(the )?(\w+)/i,
    extract: 3,
    type: VariableType.TEXT,
    description: 'Type instruction',
  },
  {
    pattern: /enter (the )?(\w+)/i,
    extract: 2,
    type: VariableType.TEXT,
    description: 'Enter instruction',
  },
  {
    pattern: /select (the )?(\w+)/i,
    extract: 2,
    type: VariableType.SELECTION,
    description: 'Select instruction',
  },
  {
    pattern: /choose (the )?(\w+)/i,
    extract: 2,
    type: VariableType.SELECTION,
    description: 'Choose instruction',
  },
  {
    pattern: /upload (the )?(\w+)/i,
    extract: 2,
    type: VariableType.FILE,
    description: 'Upload instruction',
  },
  {
    pattern: /the date (of|for) (\w+)/i,
    extract: 2,
    type: VariableType.DATE,
    description: 'Date mention',
  },
  {
    pattern: /the (number|amount|quantity) (of )?(\w+)/i,
    extract: 3,
    type: VariableType.NUMBER,
    description: 'Number mention',
  },
...
export const CONDITIONAL_PATTERNS_PT: ConditionalPattern[] = [
  {
    pattern: /se (for|tiver|houver|o|a) (.+?),?\s*(então|aí|daí)\s+(.+)/i,
    conditionGroup: 2,
    thenGroup: 4,
    description: 'Se então',
  },
  {
    pattern: /quando (o|a) (.+?)\s+(for|estiver|tiver)\s+(.+?),?\s+(.+)/i,
    conditionGroup: 2,
    thenGroup: 5,
    description: 'Quando',
  },
  {
    pattern: /dependendo (do|da|de) (.+?),?\s+(.+)/i,
    conditionGroup: 2,
    thenGroup: 3,
    description: 'Dependendo',
  },
  {
    pattern: /caso (o|a) (.+?)\s+(seja|esteja|tenha)\s+(.+?),?\s+(.+)/i,
    conditionGroup: 2,
    thenGroup: 5,
    description: 'Caso',
  },
  {
    pattern: /se não (tiver|houver|for) (.+?),?\s+(.+)/i,
    conditionGroup: 2,
    thenGroup: 3,
    description: 'Se não',
  },
  {
    pattern: /só (faz|faça|fazer) (.+?)\s+se\s+(.+)/i,
    conditionGroup: 3,
    thenGroup: 2,
    description: 'Só se',
  },
...
export const CONDITIONAL_PATTERNS_EN: ConditionalPattern[] = [
  {
    pattern: /if (the |there is |there are )?(.+?),?\s*(then |you )(.+)/i,
    conditionGroup: 2,
    thenGroup: 4,
    description: 'If then',
  },
  {
    pattern: /when (the )?(.+?)\s+(is|are|has|have)\s+(.+?),?\s+(.+)/i,
    conditionGroup: 2,
    thenGroup: 5,
    description: 'When',
  },
  {
    pattern: /depending on (the )?(.+?),?\s+(.+)/i,
    conditionGroup: 2,
    thenGroup: 3,
    description: 'Depending',
  },
  {
    pattern: /in case (the )?(.+?)\s+(is|are|has|have)\s+(.+?),?\s+(.+)/i,
    conditionGroup: 2,
    thenGroup: 5,
    description: 'In case',
  },
  {
    pattern: /if (there is no|there are no|not) (.+?),?\s+(.+)/i,
    conditionGroup: 2,
    thenGroup: 3,
    description: 'If not',
  },
...
export const CONTEXT_PATTERNS_PT: ContextPattern[] = [
  ...
  {
    pattern: /presta atenção (aqui|nisso|nessa parte)/i,
    contextType: 'important',
    description: 'Pay attention',
  },
  { pattern: /o motivo (é|disso|dessa)/i, contextType: 'reason', description: 'Reason' },
  {
    pattern: /geralmente|normalmente|na maioria das vezes/i,
...
export const CONTEXT_PATTERNS_EN: ContextPattern[] = [
  ...
  {
    pattern: /usually|normally|typically|most of the time/i,
    contextType: 'frequency',
    description: 'Frequency',
  },
...
export const ALL_VARIABLE_PATTERNS: VariablePattern[] = [
  ...VARIABLE_PATTERNS_PT,
  ...VARIABLE_PATTERNS_EN,
]
export const ALL_CONDITIONAL_PATTERNS: ConditionalPattern[] = [
  ...CONDITIONAL_PATTERNS_PT,
  ...CONDITIONAL_PATTERNS_EN,
]
export const ALL_CONTEXT_PATTERNS: ContextPattern[] = [
  ...CONTEXT_PATTERNS_PT,
  ...CONTEXT_PATTERNS_EN,
]
...
function deduplicateHints(hints: SpeechVariableHint[]): SpeechVariableHint[] {
  ...
  return Array.from(hintMap.values()).sort((a, b) => b.confidence - a.confidence)
}
