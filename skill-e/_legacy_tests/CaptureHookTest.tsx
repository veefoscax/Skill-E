...
export function CaptureHookTest() {
  const { startCapture, stopCapture, getCurrentSession } = useCapture();
  ...
  const handleStartCapture = async () => {
    ...
    const newSession = await startCapture(interval);
    console.log('Started capture session:', newSession.id);
  };
